...
func Load() Config {
	return Config{
		...
		DatabaseURL: normalizeDBURL(getenv("DATABASE_URL", "postgresql://researcher:researcher@localhost:5433/researcher")),
		...
		EmailVerificationEnabled: getenv("EMAIL_VERIFICATION_ENABLED", "true") != "false",
