...
const translations: Record<Locale, Record<TranslationKey, string>> = {
  ru: {
    ...
    'papers.sort.new': 'Новое',
    'papers.sort.hot': 'Горячее',
    ...
    'settings.languageHint': 'Меню, подсказки и системные тексты',
    'settings.themeSetting': 'Тема',
    'settings.themeHint': 'Оформление интерфейса',
    'settings.readerTheme': 'Тема в ридере',
    'settings.readerThemeHint': 'Применять тёмную тему к странице PDF',
    'settings.readerThemeBoth': 'Вместе',
