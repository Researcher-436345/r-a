...
- Используй ясную иерархию заголовков (##, ###), короткие абзацы, маркированные или нумерованные списки, **жирное выделение**, цитаты и Markdown-таблицы, когда они улучшают восприятие.
